...
export const AppContextProvider = (props) => {
    ...
    // function to calculate course ratings
    ...
    // func to calculate total lecture in a course
        const CalculateNumberOfLecture = (course) => {
            let totalLecture = 0;

            course.courseContent.forEach(chapter => {
                if(Array.isArray(chapter.chapterContent)){
                    totalLecture += chapter.chapterContent.lemgth 
                }
            })
    ...
    const value = {
            ...
            CalculateRatings, isEducator, setIsEducator,
