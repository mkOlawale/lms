        ...
        <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
           <table className='md:table-auto table-fixed w-full overflow-hidden pb-4'>
            <thead className="text-gray-900 border-b border-gray-500/20 text-sm text-left">
              ...
              <tr>
                <th className="font-semibold px-4 py-3 px-4 py-3 text-center hidden sm:table-cell">#</th>
                <th className="font-semibold px-4 py-3 ">Students Name</th>
                <th className="font-semibold px-4 py-3 ">Course Title</th>
                <th className="font-semibold px-4 py-3 hidden sm:table-cell">Date</th>
              </tr>
