...
const AddCourse = () => {
  ...
  const [showPopuo, setShowPopup] = useState(false);
  ...
  <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
    ...
    {/* Price - Thumbnail - Discount - Chapters */}
        ...
        {chapters.map((chapter, chapterIndex) => (
          <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
            ...
            <div className="flex justify-between items-center p-4 border-b">
              ...
              <img src={assets.cross_icon} className="cursor-pointer" onClick={() => handleChapter('remove', chapter.chapterId)} />
            </div>
                ...
                {chapter.chapterContent.map((lecture, lectureIndex) => (
                  ...
                  >
                    <span>
                      ...
                      mins - <a className="text-blue-500" href={lecture.lectureUrl} target="_blank">Link</a> - 
    ...
    <button 
      type="submit" 
      className="w-max bg-black text-white px-8 py-2.5 rounded my-4"
    >
      ADD
    </button>
